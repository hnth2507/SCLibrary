...
- (id)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self)
    {
        ...
        self.videoSize      = [SCHelper sizeFromArray:[dict valueForKey:@"videoSize"]];
        self.backgroundColor= [SCHelper colorFromArray:[dict valueForKey:@"backgroundColor"]];
    
        
        //slide array
        self.slideArray = [[NSMutableArray alloc] init];
        for(NSDictionary *item in [dict valueForKey:@"slideArray"])
        {
        ...
        //transition array
        self.transitionArray = [[NSMutableArray alloc] init];
        for(NSDictionary *item in [dict valueForKey:@"transitionArray"])
        {
