...
- (id)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self)
    {
        self.center     = [SCHelper vectorFromArray:[dict valueForKey:@"center"]];
        self.position   = [SCHelper vectorFromArray:[dict valueForKey:@"position"]];

        self.color      = [SCHelper colorFromArray:[dict valueForKey:@"color"]];
        self.size       = [SCHelper SCSizeFromArray:[dict valueForKey:@"size"]];
