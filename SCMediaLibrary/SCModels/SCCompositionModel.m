...
- (id)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self)
    {
        self.duration = ((NSNumber*)[dict valueForKey:@"duration"]).floatValue;
        self.startTime = ((NSNumber*)[dict valueForKey:@"startTime"]).floatValue;
        self.startTimeInTimeLine = ((NSNumber*)[dict valueForKey:@"startTimeInTimeLine"]).floatValue;
...
- (NSMutableDictionary *)toDictionary
{
    ...
    [dict setObject:self.projectURL forKey:@"projectURL"];
