    ...
    while ((dictKey = [enumerator nextObject]))
    {
        ...
        for (unsigned int i = 0; i < outCount; i++)
        {
            ...
            if([ivarType isEqualToString:@"f"] ||
               ...
               [ivarType isEqualToString:@"@\"NSData\""])
            {
...
- (NSMutableDictionary*)toDictionary
{
    ...
    for (unsigned int i = 0; i < outCount; i++)
    {
        ...
        //type float
        if([ivarType isEqualToString:@"f"] || [ivarType hasPrefix:@"@\"NSString\""] || [ivarType isEqualToString:@"c"]  || [ivarType isEqualToString:@"i"] || [ivarType isEqualToString:@"NSDate"] ||  [ivarType isEqualToString:@"NSData"])
        {
            //            NSLog(@"Float");
