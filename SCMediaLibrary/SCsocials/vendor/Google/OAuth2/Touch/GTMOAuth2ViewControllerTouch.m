...
// for google plus
- (id)initWithScopePlus:(NSString *)scope
               clientID:(NSString *)clientID
           clientSecret:(NSString *)clientSecret
       keychainItemName:(NSString *)keychainItemName
               delegate:(id)delegate
    ...
    NSURL *authorizationURL = [NSURL URLWithString:[[[signInClass googleAuthorizationURL] absoluteString] stringByAppendingString:@"?request_visible_actions=http://schemas.google.com/AddActivity"]];
